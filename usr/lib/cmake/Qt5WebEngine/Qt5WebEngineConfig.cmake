...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.12.9"
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.12.9/QtWebEngine"
    )
    ...
    macro(_populate_WebEngine_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebEngine_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_WebEngine_check_file_exists(${imported_location})
