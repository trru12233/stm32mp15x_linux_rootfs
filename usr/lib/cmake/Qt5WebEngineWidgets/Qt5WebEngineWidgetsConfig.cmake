...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.12.9"
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.12.9/QtWebEngineWidgets"
    )
    ...
    macro(_populate_WebEngineWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebEngineWidgets_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_WebEngineWidgets_check_file_exists(${imported_location})
